    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_id', models.CharField(default=None, max_length=15, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code_type', models.CharField(choices=[('gtin', 'gtin'), ('whitelisted_plu', 'whitelisted_plu')], default=None, max_length=15, null=True)),
                ...
                ('edeka_article_number', models.CharField(default=None, max_length=20, null=True)),
                ...
                ('packaging', models.CharField(choices=[('PUG', 'PUG'), ('CT', 'CT'), ('CU', 'CU'), ('BO', 'BO'), ('NE', 'NE'), ('BX', 'BX'), ('CR', 'CR'), ('BJ', 'BJ'), ('JR', 'JR'), ('PU', 'PU')], max_length=5)),
                ('trade_item_unit_descriptor', models.CharField(choices=[('CASE', 'CASE'), ('BASE_UNIT_OR_EACH', 'BASE_UNIT_OR_EACH')], max_length=17)),
                ('trade_item_unit_descriptor_name', models.CharField(choices=[('Karton', 'Karton'), ('Basiseinheit', 'Basiseinheit')], default=None, max_length=12, null=True)),
                ('requires_best_before_date', models.BooleanField(default=None, null=True)),
                ('requires_meat_info', models.BooleanField(default=False)),
                ('validation_status', models.CharField(choices=[('validated', 'validated'), ('unvalidated', 'unvalidated')], max_length=11)),
                ('vat_country_name', models.CharField(default=None, max_length=30, null=True)),
                ('vat_label', models.CharField(default=None, max_length=15, null=True)),
                ('vat_rate_code', models.IntegerField(default=None, null=True)),
                ('vat_rate', models.CharField(choices=[('STANDARD', 'STANDARD'), ('LOW', 'LOW')], default=None, max_length=8, null=True)),
                ('regulated_name', models.CharField(default=None, max_length=100, null=True)),
                ...
                ('meat_info', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='products.meatinfo')),
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='children', to='products.product')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='stocks_by_expiry_date', to='products.product')),
            ],
        ),
        migrations.CreateModel(
            name='Session',
            fields=[
                ...
                ('supplier', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='sessions', to='products.supplier')),
        ...
        migrations.AddField(
            model_name='product',
            name='session',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='products', to='products.session'),
        ),
        migrations.AddConstraint(
            model_name='category',
            constraint=models.UniqueConstraint(fields=('categ_id', 'category_id'), name='unique_category'),
        ),
    ]
